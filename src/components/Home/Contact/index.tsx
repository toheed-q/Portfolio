          ...
          <div
            ...
            <div className='grid grid-cols-6 pb-12 border-b border-dark_border '>
              <div className='col-span-3'>
                ...
                <a href='https://www.linkedin.com/in/toheed-qureshi-dotnet-developer/' target='_blank' rel='noopener noreferrer' className='bg-transparent border-0 text-white text-lg hover:text-blue-400'>
                  View Profile
                </a>
              </div>
              <div className='col-span-3'>
              ...
              <div className='col-span-6 pt-8'>
                <span className='text-white/50 text-lg'>GitHub</span>
                <a href='https://github.com/toheed-q' target='_blank' rel='noopener noreferrer' className='bg-transparent border-0 text-white text-lg hover:text-blue-400'>
                  github.com/toheed-q
                </a>
              </div>
            </div>
            <div className='pt-12'>
              ...
              <div className='flex items-center flex-wrap md:gap-8 gap-4'>
                <span className='text-white text-sm bg-blue-600/20 px-4 py-2 rounded-lg'>ASP.NET Core</span>
                <span className='text-white text-sm bg-blue-600/20 px-4 py-2 rounded-lg'>Blazor</span>
                <span className='text-white text-sm bg-blue-600/20 px-4 py-2 rounded-lg'>C#</span>
                <span className='text-white text-sm bg-blue-600/20 px-4 py-2 rounded-lg'>SQL Server</span>
                <span className='text-white text-sm bg-blue-600/20 px-4 py-2 rounded-lg'>Azure</span>
              </div>
            </div>
          </div>
          <div
